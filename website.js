setInterval(function() {
    ...
    document.getElementById("total2").innerHTML = `That means that in <br><strong style="font-size: 1em;">${(Math.round(3204668000000 - (seconds * 475.64))/450/60/60/24/365).toFixed(8)}</strong><br> years, there won't be any at all.`
